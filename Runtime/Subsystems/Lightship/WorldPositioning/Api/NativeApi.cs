...
namespace Niantic.Experimental.Lightship.AR.Subsystems.WorldPositioning
{
    public class NativeApi : IApi
    {
        ...
        public WorldPositioningStatus TryGetXRToWorld(IntPtr providerHandle, out Matrix4x4 arToWorld, out double originLatitude, out double originLongitude, out double originAltitude)
        {
            ...
            WorldPositioningStatus status = (WorldPositioningStatus) Native.GetLatestTransform(providerHandle, poseArray, out originLatitude, out originLongitude, out originAltitude);
        ...
        private static class Native
        {
            ...
            [DllImport(LightshipPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_WPS_GetLatestTransform")]
            public static extern uint GetLatestTransform(IntPtr handle, [Out] float[] transform_out,
