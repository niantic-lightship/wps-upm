...
namespace Niantic.Experimental.Lightship.AR.XRSubsystems
{
    ...
    public class XRWorldPositioningSubsystem
        : SubsystemWithProvider<XRWorldPositioningSubsystem, XRWorldPositioningSubsystemDescriptor, XRWorldPositioningSubsystem.Provider>
    {
        ...
        public WorldPositioningStatus TryGetXRToWorld(ref Matrix4x4 arToWorld, ref double originLatitude, ref double originLongitude, ref double originAltitude)
            => provider.TryGetXRToWorld(ref arToWorld, ref originLatitude, ref originLongitude, ref originAltitude);
        ...
        public abstract class Provider : SubsystemProvider<XRWorldPositioningSubsystem>
        {
            ...
            /// <c>false</c>.
            /// </returns>
            public virtual WorldPositioningStatus TryGetXRToWorld(ref Matrix4x4 arToWorld, ref double originLatitude, ref double originLongitude, ref double originAltitude)
                => throw new NotSupportedException("TryGetXRToWorld is not supported by this implementation");
        }
    }
}
